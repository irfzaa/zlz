...
const ROUTES = [
  { url: RouteName.home, name: "PAW Marketplace" },
  { url: RouteName.sell, name: "List With PAW" },
  {
    url: RouteName.multipleCurrencyMarketplace,
    name: "Bloodlust Marketplace",
  },
  { url: RouteName.multipleCurrencySell, name: "LIST with Bloodlust" },
  
];

const OTHER_LAYOUT_ROUTES = [
  { url: RouteName.auctionsView, name: "PAW Auctions" },
